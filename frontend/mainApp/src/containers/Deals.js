...
const Deals = () => {
  ...
  const [characters, updateCharacters] = useState(deals);
                  ...
                  {characters.map((item) => {
                    ...
                    return (
                      <Draggable key={id} draggableId={id} index={index}>
                        {(provided) => {
                          <div
                            className='grid grid-cols-4 border border-t-0 border-gray-300 rounded h-screen2'
                            ...
                            <div className='border-r border-gray-300 overflow-y-auto rounded py-2 flex flex-col items-center gap-4'>
                              {deals
                                .filter(
                                  (x) =>
                                    x.deal_stage &&
                                    x.deal_stage.toLowerCase() === 'prospect'
                                )
                                .map((deal, i) => (
                                  <DealCard
                                    key={deal._id}
                            ...
                            <div className=' border-r border-gray-300 overflow-y-auto rounded py-2 flex flex-col items-center gap-4'>
                              {deals
                                .filter(
                                  (x) =>
                                    x.deal_stage &&
                                    x.deal_stage.toLowerCase() === 'proposal'
                                )
                                .map((deal, i) => (
                                  <DealCard
                                    key={deal._id}
                            ...
                            <div className=' border-r border-gray-300 overflow-y-auto rounded py-2 flex flex-col items-center gap-4'>
                              {deals
                                .filter(
                                  (x) =>
                                    x.deal_stage &&
                                    x.deal_stage.toLowerCase() === 'closed'
                                )
                                .map((deal, i) => (
                                  <DealCard
                                    key={deal._id}
